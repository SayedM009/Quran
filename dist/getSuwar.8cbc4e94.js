...
module.bundle.HMR_BUNDLE_ID = "70ea02fc8cbc4e94";
"use strict";
...
async function getSuwar(lang) {
    ...
    const response = await fetch(`https://mp3quran.net/api/v3/suwar?language=${finalLng}`);
...
//# sourceMappingURL=getSuwar.8cbc4e94.js.map
