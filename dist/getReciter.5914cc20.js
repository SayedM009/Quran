...
module.bundle.HMR_BUNDLE_ID = "68ef43595914cc20";
"use strict";
...
},{}],"7bSPa":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getReciter", ()=>getReciter);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const selectreciter = document.querySelector(".data__reciters--list--x");
async function getReciter(lang) {
    try {
        ...
        async function cehckFullfilledResults(...all) {
            return Promise.allSettled(all.map((url)=>(0, _axiosDefault.default).get(url))).then((result)=>result.filter((res)=>res.status === "fulfilled"));
        }
        const response = await cehckFullfilledResults(`https://www.mp3quran.net/api/v3/reciters?language=${finalLng}&reciter=168`, `https://www.mp3quran.net/api/v3/recent_reads?language=${finalLng}`);
        ...
        if (response.length >= 2) {
            const [{ value: { data: { reciters } } }, { value: { data: { reads } } }] = response;
            const all = [
                ...reciters,
                ...reads
            ];
        ...
        if (require("bf15059ca097191f")) require("bf15059ca097191f").then((modal)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","axios":"kooH4","bf15059ca097191f":"fAvgw"}],"fAvgw":[function(require,module,exports,__globalThis) {
module.exports = import("./ErrorModal.63a6616a.js").then(()=>module.bundle.root('ameYG'));

},{"ameYG":"ameYG"}]},["c36xP","7bSPa"], "7bSPa", "parcelRequirefab8", {})

//# sourceMappingURL=getReciter.5914cc20.js.map
