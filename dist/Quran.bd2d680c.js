...
})({"8UcC7":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "5febe29ebd2d680c";
"use strict";
...
},{}],"89AEk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getChannels", ()=>getChannels);
parcelHelpers.export(exports, "selectChannel", ()=>selectChannel);
parcelHelpers.export(exports, "carouselChannels", ()=>carouselChannels);
...
async function getChannels(language, selecteElement, carouselContainer) {
    try {
        // 1. Check if the channels select element is exists
        if (!selecteElement || !carouselContainer) throw new Error("One or more elements are not exists please check it.");
        const finalLng = language === "en" ? "eng" : "ar";
        // 2. Fetch radio channels from API
        const response = (0, _axiosDefault.default).get(`https://mp3quran.net/api/v3/radios?language=${finalLng}`);
        ...
        if (require("e06e2fc7f7fe12af")) require("e06e2fc7f7fe12af").then((modal)=>{
...
myCarousel.addEventListener("slide.bs.carousel", (event)=>{
    const channelName = event.relatedTarget.children[0].textContent.substring(0, 30);
    ...
    document.querySelector(".data__channel--list + span .select2-selection__rendered").innerHTML = channelName;
});

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","axios":"kooH4","e06e2fc7f7fe12af":"fAvgw"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fAvgw":[function(require,module,exports,__globalThis) {
module.exports = import("./ErrorModal.63a6616a.js").then(()=>module.bundle.root('ameYG'));

},{"ameYG":"ameYG"}]},["8UcC7","89AEk"], "89AEk", "parcelRequirefab8", {})

//# sourceMappingURL=Quran.bd2d680c.js.map
