...
})({"kbxMs":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "2eaf6f8ae737a97f";
"use strict";
...
},{}],"ayBmj":[function(require,module,exports,__globalThis) {
...
async function getPages(num = 1) {
    ...
    try {
        const response = await (0, _axiosDefault.default).get(`https://mp3quran.net/api/v3/ayat_timing?surah=${num}&read=1`);
        const data = response.data.map((ele)=>ele.page).filter((page)=>page != null);
        carouselPages.innerHTML = "";
        const unurl = new Set(data);
        [
            ...unurl
        ].reverse().forEach((src, i, arr)=>{
            carouselPages.insertAdjacentHTML("beforeend", `
          <div class="carousel-item rounded-2 ${i === [
                ...unurl
            ].length - 1 ? "active" : ""} text-center">
            <img src="${src}" style="max-width:480px">
          </div>`);
        });
...
function updateButtons() {
    ...
    if (activeIndex === 0) prevButton.disabled = true;
    else prevButton.disabled = false;
    // لو على آخر صفحة، عطل زر "التالي"
    if (activeIndex === items.length - 1) nextButton.disabled = true;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kbxMs"], null, "parcelRequirefab8", {})

//# sourceMappingURL=PagesOfSwrah.e737a97f.js.map
